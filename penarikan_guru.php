...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Simpan ke tabel penarikan_guru
    $sql = "INSERT INTO penarikan_guru (guru_pembimbing, siswa_pkl, tempat_dudi, tanggal_pelaksanaan, catatan_monitoring, dokumentasi)
            VALUES (?, ?, ?, ?, ?, ?)";
    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-light navbar-light">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="penarikan_guru.php" class="nav-item nav-link active"><i class="fa-solid fa-hand-holding-heart me-2"></i>Penarikan</a>

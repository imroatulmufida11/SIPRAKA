...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO permohonan_pkl (nomor_surat, tempat_pkl, alamat_pkl, konsentrasi_keahlian, siswa, tanggal_mulai, tanggal_berakhir) 
            VALUES ('$nomor_surat', '$tempat_pkl','$alamat_pkl', '$konsentrasi_keahlian', '$siswa', '$tanggal_mulai', '$tanggal_berakhir')";

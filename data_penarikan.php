...
// Ambil data dari tabel penarikan_guru
$sql = "SELECT * FROM penarikan_guru ORDER BY created_at DESC";
    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-light navbar-light">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="from_penarikan.php" class="nav-item nav-link active"><i class="fa-solid fa-hand-holding-heart me-2"></i>Surat Penarikan</a>
    ...
    <div class="row g-4">
        <div class="col-12">
            <div class="bg-light rounded h-100 p-4">
                <h2 class="mb-4">Data Penarikan Guru</h2>
                            ...
                            if (isset($result) && $result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    if (!empty($row['dokumentasi'])) {
                                        echo "<img src='{$row['dokumentasi']}' alt='Dokumentasi' width='100' class='img-thumbnail'>";
                                    } else {
                                        echo "-";
                                    }
                                    echo "</td>
